...
async def seed_fake_data(db_session):
    ...
    plan1 = TokenPlan(name="Plan A", api_type="openai", api_base="https://api.example.com", api_key="k1", model="gpt-4", is_active=True)
    plan2 = TokenPlan(name="Plan B", api_type="anthropic", api_base="https://api.anthropic.com", api_key="k2", model="claude-3", is_active=True)
